...
AI-ассистент подойдет в первую очередь разработчика, администртора, аналитика, тестировщикам,
разрабатывающим на платформе **Websoft HCM**. Но ассисент может получать данные по любым объектам системы.
...
- `<версия>` — конкретный выпуск, например `2.3.1-beta.1525`.
